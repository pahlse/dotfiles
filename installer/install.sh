...
dotfilesrepo="https://github.com/pahlse/dotfiles.git"
progsfile="./progfile"
aurhelper="yay"
repobranch="master"
...
welcomemsg() { \
	echo "Welcome to Luke's Auto-Rice Bootstrapping Script! This script will automatically install a fully-featured Linux desktop, which I use as my main machine."

	echo "Be sure the computer you are using has current pacman updates and refreshed Arch keyrings. If it does not, the installation of some programs might fail."
	}
